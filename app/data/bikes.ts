...
const roadBikes: Bike[] = [
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT Aero 45 Carbon Tubeless" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT Endurance 30 Alloy Tubeless" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Groupset", value: "Shimano Ultegra Di2 12-speed" },
      { label: "Wheels", value: "EIGHT Aero 60 Carbon Tubeless" },
      { label: "Brakes", value: "Shimano Ultegra Hydraulic Disc" },
...
const mountainBikes: Bike[] = [
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT Trail 29 Alloy Tubeless" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT XC Carbon 29 Tubeless" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT Enduro 29 Alloy Tubeless" },
...
const gravelBikes: Bike[] = [
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT Gravel 700c Alloy Tubeless" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT AllRoad 700c Alloy Tubeless" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Wheels", value: "EIGHT Adventure 700c Alloy Tubeless" },
      { label: "Brakes", value: "Shimano GRX Hydraulic Disc" },
